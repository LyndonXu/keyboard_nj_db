...
#define ADC_CHANNEL_5			ADC_Channel_0
#define ADC_CHANNEL_6			ADC_Channel_1
#define ADC_CHANNEL_7			ADC_Channel_4
#define ADC_CHANNEL_8			ADC_Channel_5
...
#define ADC_PIN_6				GPIO_Pin_1
#define ADC_PIN_7				GPIO_Pin_4
#define ADC_PIN_8				GPIO_Pin_5

#define ADC_PORT_1				GPIOC
#define ADC_PORT_2				GPIOC
#define ADC_PORT_3				GPIOC
#define ADC_PORT_4				GPIOC
#define ADC_PORT_5				GPIOA
#define ADC_PORT_6				GPIOA
#define ADC_PORT_7				GPIOA
#define ADC_PORT_8				GPIOA



#define ADC_GET_TOTAL				8
...
#define ROCK_NEGATIVE_END		1460
#define ROCK_NEGATIVE_BEGIN		1843

#define ROCK_POSITIVE_END		2600
#define	ROCK_POSITIVE_BEGIN		2217
