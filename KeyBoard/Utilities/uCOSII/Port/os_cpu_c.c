...
/*
*********************************************************************************************************
*                                          OS_CPU_SetInterruptMask()
*
* Description: set the interrupt mask.
*
* Arguments  : none.
*
* note: the interrupt whose protity is greater than the OS_MAX_SYSCALL_INTERRUPT_PRIORITY(lower numeric
* value) must not use the uCOS's API
*********************************************************************************************************
*/
__asm void OS_CPU_SetInterruptMask(void)
{
	PRESERVE8

	MOV		R0, #OS_MAX_SYSCALL_INTERRUPT_PRIORITY
	MSR		BASEPRI, R0
	BX		R14
}
...
/*
*********************************************************************************************************
*                                          OS_CPU_ClearInterruptMask()
*
* Description: Clear the interrupt mask.
*
* Arguments  : none.
*
*********************************************************************************************************
...
__asm void OS_CPU_PendSVHandler(void)
{
	...
	MOV     R0, #OS_MAX_SYSCALL_INTERRUPT_PRIORITY				; Prevent interruption during context switch
	MSR     BASEPRI, R0
#endif
